...
const statements = [
  "Admis en BUT Informatique pour la rentrée.",
  "Créateur de SaaS modernes et performants.",
  "Systèmes d'IA agentiques et Second Cerveau IPCRA.",
  "Architecte d'interfaces Next.js & Tailwind CSS.",
  "Concevoir des produits qui transforment les idées en réalité.",
]
...
export function About() {
  ...
  return (
    <section id="about" ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">03 — PHILOSOPHIE & PARCOURS</p>
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Vision & Ingénierie</h2>
      </motion.div>
